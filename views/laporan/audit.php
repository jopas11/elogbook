    ...
    <div class="glass-panel p-4 mb-6">
        <form method="GET" action="index.php" onsubmit="submitFilter(this);return false" class="flex flex-wrap gap-3 items-end">
            ...
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="search" value="<?= escape($search) ?>" placeholder="Action, deskripsi, user, IP..." class="w-full px-3 py-2.5 border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 dark:text-gray-200 rounded-xl text-base focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/50 outline-none transition-all duration-200">
            </div>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            ...
                            $actionColors = [
                                ...
                                'user_dibuat' => 'text-blue-600 dark:text-blue-400',
                                'user_diubah' => 'text-blue-600 dark:text-blue-400',
